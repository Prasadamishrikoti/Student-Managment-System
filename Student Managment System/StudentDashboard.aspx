<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentDashboard.aspx.cs" Inherits="Student_Managment_System.WebForm2" %>
...
<ul class="navbar-nav">
    ...
    <form id="form1" runat="server">
        ...
        <p style="font-size:larger">
            Date Of Joining:<asp:Label ID="Label3" runat="server"></asp:Label>
        </p>
            </div>
